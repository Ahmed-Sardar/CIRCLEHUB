  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        {/* Title */}
        <div className='mb-8'>
          {/* <h1 className='text-3xl font-bold text-slate-900 mb-2">Messages'>Connections</h1> */}
          {/* // LINE: the <h1> line inside the "Title" div */}
        ...
        border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
          {
            dataArray.map((tab)=>(
...
{/* CONNECTIONS */}
          ...
          {dataArray.find((item)=> item.label === currentTab).value.map((user)=>(
            <div key={user._id} className='w-full max-w-3xl flex 
              ...
              <img src={user.profile_picture} alt="" className='rounded-full w-12
               ...
               <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  {
                    <button onClick={()=>navigate(`/profile/${user._id}`)}className="w-full p-2 
                    text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 
